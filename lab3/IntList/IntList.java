...
public class IntList {
    ...
    private static IntList d_addLast(IntList A, IntList B) {
        if (A == null) {
            ...
            A = new IntList(A.first, d_addLast(A.rest, B));
        }
    ...
    public static IntList reverse(IntList A) {
        ...
        IntList B = helper(temp, A);
        A.first = B.first;  // that's so trick and sneaky, I just can't figure out the destructive expression right now
        A.rest = B.rest;
        return B;
    }

    private static IntList helper(IntList temp, IntList list) {
        if (list.rest == null) {
            temp.first = list.first;
            return temp;
        } else {
            temp.rest = new IntList(list.first, temp.rest);
            return helper(temp,list.rest);
        }
    }
}
